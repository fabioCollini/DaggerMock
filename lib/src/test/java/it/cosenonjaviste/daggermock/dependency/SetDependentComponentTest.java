...
public class SetDependentComponentTest {
    ...
    public final DaggerMockRule<MyComponent> rule = new DaggerMockRule<>(MyComponent.class, new MyModule())
            ...
            .set(MyComponent2.class, new DaggerMockRule.ComponentSetter<MyComponent2>() {
                @Override public void setComponent(MyComponent2 component) {
                    myService2 = component.myService2();
                }
            });
