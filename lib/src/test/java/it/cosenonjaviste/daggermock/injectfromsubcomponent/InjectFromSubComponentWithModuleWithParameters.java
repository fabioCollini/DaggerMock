...
public class InjectFromSubComponentWithModuleWithParameters {
    @Rule public final DaggerMockRule<MyComponent> rule = new DaggerMockRule<>(MyComponent.class);
    ...
    public interface MyComponent {
        MySubComponent subcomponent(MyModule module);
    }
}
