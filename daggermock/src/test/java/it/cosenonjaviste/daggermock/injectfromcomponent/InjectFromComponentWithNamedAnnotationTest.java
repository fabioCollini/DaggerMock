...
public class InjectFromComponentWithNamedAnnotationTest {
    ...
    @InjectFromComponent @Named("s1") String s1;
    @InjectFromComponent @Named("s2") String s2;
    ...
    public static class MyModule {
        @Named("s1") @Provides public String provideS1() {
            return "s1";
        }

        @Named("s2") @Provides public String provideS2() {
            return "s2";
        }
    }
