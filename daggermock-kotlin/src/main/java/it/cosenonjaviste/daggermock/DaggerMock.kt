...
//
//    companion object {
//        inline fun <reified C> rule(vararg modules: Any, noinline init: DaggerMock<C>.(C) -> Unit = {}): DaggerMockRule<C> {
//            val rule = DaggerMockRule(C::class.java, *modules)
//            DaggerMock<C>(rule).apply {
//                rule.set { component -> init(component) }
//            }
//            return rule
//        }
//    }
